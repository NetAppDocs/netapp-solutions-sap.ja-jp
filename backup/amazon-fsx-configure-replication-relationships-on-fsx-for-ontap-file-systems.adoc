...
link:amazon-fsx-backup-replication-with-snapvault_overview.html["Previous：Overview：SnapVault によるバックアップ・レプリケーション"]
...
sapcc-hana-svm:PFX_data_mnt00001
            XDP  sapcc-backup-target-zone5:PFX_data_mnt00001
                              Snapmirrored
                                      Idle           -         true    -
....
link:amazon-fsx-add-a-backup-svm-to-snapcenter.html["次の手順：SnapCenter にバックアップSVMを追加します。"]
