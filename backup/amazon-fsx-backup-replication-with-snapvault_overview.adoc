...
link:amazon-fsx-backup-of-non-data-volumes.html["Previous：非データボリュームのバックアップ。"]
...
link:amazon-fsx-configure-replication-relationships-on-fsx-for-ontap-file-systems.html["次の手順：ONTAP ファイルシステムのレプリケーション関係をFSXで設定します。"]
