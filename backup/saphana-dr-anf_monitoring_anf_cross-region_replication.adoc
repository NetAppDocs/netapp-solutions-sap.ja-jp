...
image::saphana-dr-anf_image14.png[SAPHana DR anfイメージ14]

次のスクリーンショットは、 HANA のログバックアップボリュームのレプリケーションステータスを示しています。

image::saphana-dr-anf_image15.png[SAPHana DR anfイメージ15]

次のスクリーンショットは、 HANA 共有ボリュームのレプリケーションステータスを示しています。

image::saphana-dr-anf_image16.png[SAPHana DR anfイメージ16]
...
image::saphana-dr-anf_image17.png[SAPHana DR anfイメージ17]
