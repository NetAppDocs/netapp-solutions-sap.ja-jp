...
image:libelle-sc-image31.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:libelle-sc-image32.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]

更新操作を開始するには、LSC GUIで正しい設定を選択し、[実行の開始]をクリックします。

image:libelle-sc-image33.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]

LSCは、チェックフェーズのタスクの実行を開始し、プリフェーズの設定済みタスクを実行します。

image:libelle-sc-image34.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:libelle-sc-image35.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:libelle-sc-image36.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]

image:libelle-sc-image37.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:libelle-sc-image38.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:libelle-sc-image39.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
