...
image::libelle-sc-image23.png[libelle SCイメージ23]
...
image::libelle-sc-image24.png[libelle SCイメージ24]
...
image::libelle-sc-image25.png[libelle SCイメージ25]
...
image::libelle-sc-image26.png[libelle SCイメージ26]
...
image::libelle-sc-image27.png[libelle SCイメージ27]
...
image::libelle-sc-image28.png[libelle SCイメージ28]
...
image::libelle-sc-image29.png[libelle SCイメージ29]
...
image::libelle-sc-image30.png[libelle SCイメージ30]
...
image::libelle-sc-image31.jpg[libelle SCイメージ31]
...
image::libelle-sc-image32.jpg[libelle SCイメージ32]

更新操作を開始するには、LSC GUIで正しい設定を選択し、[実行の開始]をクリックします。

image::libelle-sc-image33.jpg[libelle SCイメージ33]

LSCは、チェックフェーズのタスクの実行を開始し、プリフェーズの設定済みタスクを実行します。

image::libelle-sc-image34.jpg[libelle SCイメージ34]
...
image::libelle-sc-image35.jpg[libelle SCイメージ35]
...
image::libelle-sc-image36.jpg[libelle SCイメージ36]

image::libelle-sc-image37.jpg[libelle SCイメージ37]
...
image::libelle-sc-image38.jpg[libelle SCイメージ38]
...
image::libelle-sc-image39.jpg[libelle SCイメージ39]
