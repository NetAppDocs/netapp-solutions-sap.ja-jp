...
image::sc-copy-clone-image41.png[SCコピークローンイメージ41]
...
image::sc-copy-clone-image42.png[SCコピークローンイメージ42]
...
image::sc-copy-clone-image43.png[SCコピークローンイメージ43]
...
image::sc-copy-clone-image44.png[SCコピークローンイメージ44]

. SnapCenter の[ジョブの詳細]画面に、処理の進捗状況が表示されます。


image::sc-copy-clone-image45.png[SCコピークローンイメージ45]
...
image::sc-copy-clone-image46.png[SCコピークローンイメージ46]
...
image::sc-copy-clone-image47.png[SCコピークローンイメージ47]

. ターゲット修復システムの準備が完了したホストを選択します。NFSエクスポートのIPアドレスは、ターゲットホストのストレージネットワークインターフェイスである必要があります。ターゲットSIDとして、ソースシステムと同じSIDを保持します。この例では、SS1


image::sc-copy-clone-image48.png[SCコピークローンイメージ48]
...
image::sc-copy-clone-image49.png[SCコピークローンイメージ49]
