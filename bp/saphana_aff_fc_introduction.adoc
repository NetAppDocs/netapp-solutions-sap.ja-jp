...
* AFF A150、AFF A220、AFF A250、AFF A300、AFF A320AFF A400、AFF A700s、AFF A700、AFF A800、AFF A900
* AFF C250、AFF C400、AFF C800
* ASA AFF A220 、 ASA AFF A250 、 ASA AFF A400 、 ASA AFF A700 、 ASA AFF A800 ASA AFF A900 の略
+

NOTE: NetApp AFF CシリーズにはNetApp ONTAP 9.13.1以降が必要です
...
ストレージを仮想マシン（ VM ）に接続する方法はいくつかあります。推奨される方法は、ストレージボリュームと NFS をゲストオペレーティングシステムから直接接続することです。このオプションについては、を参照してください link:https://review.docs.netapp.com/us-en/netapp-solutions-sap_main/bp/saphana_aff_nfs_introduction.html["NFS を使用した NetApp AFF システムでの SAP HANA"]。
