...
image:saphana_aff_nfs_image13.png["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:saphana_aff_nfs_image14.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:saphana_aff_nfs_image15.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:saphana_aff_nfs_image16.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
...
image:saphana_aff_nfs_image17.jpg["入力/出力ダイアログを示す図、または書き込まれた内容を表す図"]
